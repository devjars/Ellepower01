      ...
      px-6 sm:px-12">
        <div className="w-full flex flex-col items-center text-center pt-16 lg:pt-28 lg:w-[75%] ">
            ...
            <div className="w-full flex flex-col gap-4 items-center mt-8 lg:flex-row lg:justify-center">
                <Link to="/book-service" className="flex items-center justify-center gap-4 btn btn-primary btn-wide py-6">
             BOOK A SERVICE <span><RxArrowTopRight /></span>
                </Link>
                  <Link to="/product" className="flex items-center justify-center gap-4 btn btn-secondary btn-wide btn-outline py-6">
