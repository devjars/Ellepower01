...
function SectionFrame({label,link,headline,subheadline,buttonlabel,buttonlink,children} : props) {
  return (
    <section className="w-full  bg-base-100 overflow-x-hidden">
      <div className=" sm:w-[90%] md:w-[80%] lg:w-[95%] xl:w-[90%]  mx-auto ">
        ...
        <div className="w-full flex flex-col items-center lg:items-start">
            ...
            <h2 className="mt-8 font-bold text-2xl px-4 text-center  font-primary sm:text-2xl md:text-3xl lg:px-0 lg:text-5xl lg:text-left ">Elle Power Electrical<span className="text-primary">{headline}</span></h2>
        </div>
